...
To use **AS** in SQL, insert it right after the column you select. Here's an example of a query with an AS clause:


<img src='./images/AS_WITH_03.png' 
style="float: center; margin-right: 20px;"/>
...
<img src='./images/AS_WITH_05.png' 
style="float: center; margin-right: 20px;"/>

-  It's important to note that CTEs only exist inside the query where you create them, and you can't reference them in later queries. So, any query that uses a CTE is always broken into two parts: (1) first, we create the CTE, and then (2) we write a query that uses the CT
